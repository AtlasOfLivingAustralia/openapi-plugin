...
//     */
//    static List<Parameter> collectConstructorParameters(Class<?> cls, Components components, String[] classConsumes, JsonView jsonViewAnnotation) {
...
//     * @return the collection of supported parameters
//     */
//    static List<Parameter> collectFieldParameters(Class<?> cls, Components components, String[] classConsumes, JsonView jsonViewAnnotation) {
//        final List<Parameter> parameters = new ArrayList<>()
...
//    }
//
//    static Optional<List<String>> getStringListFromStringArray(String[] array) {
//        if (array == null) {
...
//    }
//
//    static boolean isIgnored(String path, OpenAPIConfiguration config) {
...
//    }
//
//    static String getPath(String classLevelPath, String methodLevelPath, String parentPath, boolean isSubresource) {
...
//    }
//
//    static String getHttpMethodFromCustomAnnotations(Method method) {
